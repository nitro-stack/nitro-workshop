...
- The [Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest?WT.mc_id=nitro-workshop-yolasors) to create resources on Azure. If you do not want to install it locally, you can use [https://shell.azure.com?WT.mc_id=nitro-workshop-yolasors](https://shell.azure.com/?WT.mc_id=nitro-workshop-yolasors).
